...
# CTC 网络配置
config :explorer, :base_currency, System.get_env("BASE_CURRENCY") || "ETH2"
config :explorer, :coin_name, System.get_env("COIN_NAME") || "ETH2"
config :explorer, :coin, System.get_env("COIN") || "ETH2"
